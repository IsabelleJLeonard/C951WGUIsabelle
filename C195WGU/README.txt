...
-HOW TO RUN THE PROGRAM:
  -The opening screen will show log in screen, it have log in button and it will show your local time zone. Based on local time zone, it will show in either French or English language.
    The user can log in with their username and password. There will be an alert if username or password is incorrect. There will be an alert if there is any appointment within 15 mins or there is no appointment.

  -After successfully logged in, second screen will appear with 4 buttons. The user can pick Customers, Appointment, Reports, and Log out. Each button will lead the user to next screen.
   Log out button will lead the user back to log in screen.

  -The customer button will lead to Customer List, it will show the table with list of Customer's information. On the bottom of screen, there will be 4 buttons to pick from. The user can pick from either Add customer,
   edit customer, delete customer, and back. Back button will lead the user back to second screen.

 -The appointment button will lead to Appointment List, it will show the table of appointment lists. There are 3 radio buttons for week, month, and all. The user can view appointment in week time, month time, or whole
  appointments. On the bottom of the table, there are add, edit, delete, and back buttons. Back button will lead the user back to second screen.

 -The report button will lead to report list, it will show three tabs. Each tab have its own report, Appointment total, Contact appointment, and country total. Appointment total tab will show each type, its month, and
  how many appointment in total for its specific type and month. Second tab, Contact Appointment will have contact combo box to pick from. Once a contact is selected, its contact appointment will show on the table.

 -In the report, 3rd table is reporting Country and Customer. The report will display 3 different country and how many customer in each Country the column.
